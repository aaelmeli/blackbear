...
[Mesh]
    ...
    [removeConcrete]
      ...
      block = '1'
    []
#rotate 90 deg and offset it then stach/combine this with the original mesh
    [rotatey]
      type = TransformGenerator
      input = removeConcrete
      transform = 'rotate'
      vector_value = '0 90 0'
    []
    ...
    [combined]
      ...
      inputs = 'meshfile2 rebar_y_ID rebar_z_ID'
    []
[]
...
[AuxVariables]
  ...
  [axial_slip_2]
  []
  [axial_plastic_slip_2]
  []
  [axial_force_3]
  []
  [axial_slip_3]
  []
  [axial_plastic_slip_3]
  []
  [axial_force_4]
  []
  [axial_slip_4]
  []
  [axial_plastic_slip_4]
  []
[]
...
[Constraints]
  [rebar_x2]
    ...
    max_bondstress = 1e6
    transitional_slip_value = 1e-3
    rebar_radius = 7.98e-3
    penalty = 1e9
    formulation = PENALTY
    bondslip_model = concrete_rebar_model
    output_axial_slip = axial_slip_2
    output_axial_force = axial_force_2
    output_axial_plastic_slip = axial_plastic_slip_2
  []
  [rebar_y2]
    type = ADRebarBondSlipConstraint
    secondary = 2
  ...
  [rebar_x3]
    ...
    formulation = PENALTY
    bondslip_model = concrete_rebar_model
    output_axial_slip = axial_slip_3
    output_axial_force = axial_force_3
    output_axial_plastic_slip = axial_plastic_slip_3
  []
  [rebar_y3]
    type = ADRebarBondSlipConstraint
    secondary = 3
  ...
  [rebar_x4]
    ...
    formulation = PENALTY
    bondslip_model = concrete_rebar_model
    output_axial_slip = axial_slip_4
    output_axial_force = axial_force_4
    output_axial_plastic_slip = axial_plastic_slip_4
  []
  [rebar_y4]
    type = ADRebarBondSlipConstraint
    secondary = 4
